...
//////		다운받은 이 코드의 문제점!
///////////////////////////////////////////////////////////
// 1. 그냥 Queue를 쓰면 안됨. 계속 채우기만 하기 때문에, 버퍼가 다 차면, 메모리 에러가 발생함.

	해결 방법: Circular Queue 를 사용해야 함.
...
public:
	...
	DWORD		m_dwRemainedRX;			// 수신부에 남아있는 byte 수
	//BOOL		bWriteRes;				// 송신

	BOOL        m_bReceivedAll;			// data를 계속 받기 위해서
	BOOL		m_bWaitingOnRead;		// 수신이 끝날때까지 대기 flag
