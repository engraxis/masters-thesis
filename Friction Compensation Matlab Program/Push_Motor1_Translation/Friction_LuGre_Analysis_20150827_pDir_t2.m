...
figure(1)
% Error
plot(DATA1(1:11000,11))
title('Error [mm/s]')

figure(2)
plot(DATA1(1160:11000,11))

%%
% 1번: 2000:10000
V1 = DATA1(2500:10000, 5);
F1 = DATA1(2500:10000, 9);
P1 = DATA1(2500:10000, 3);
Verr1 = DATA1(2500:10000, 11);
...
%%    
% 2번: 1000:5000
V2 = DATA2(1600:5000, 5);
F2 = DATA2(1600:5000, 9);
P2 = DATA2(1600:5000, 3);
Verr2 = DATA2(1600:5000, 11);
...
%%
% 24: 1620:1920
V24 = DATA24(1650:1920, 5);
F24 = DATA24(1650:1920, 9);
Verr24 = DATA24(1650:1920, 11);
idx = find(Verr24 == 0);
...
%%
% 25: 1520:1800
V25 = DATA25(1550:1800, 5);
F25 = DATA25(1550:1800, 9);
Verr25 = DATA25(1550:1800, 11);
idx = find(Verr25 == 0);
...
%%
% 26: 1320:1600
V26 = DATA26(1330:1600, 5);
F26 = DATA26(1330:1600, 9);
Verr26 = DATA26(1330:1600, 11);
idx = find(Verr26 == 0);
...
%%
% 27: 1400:1700
V27 = DATA27(1440:1700, 5);
F27 = DATA27(1440:1700, 9);
Verr27 = DATA27(1440:1700, 11);
idx = find(Verr27 == 0);
...
%%
% 28: 1200:1450
V28 = DATA28(1220:1450, 5);
F28 = DATA28(1220:1450, 9);
Verr28 = DATA28(1220:1450, 11);
idx = find(Verr28 == 0);
...
%x0 = [0.87 0.0 0.01 0.0];

options = optimoptions('fmincon', 'TolX', 1e-11);
%[x, fval, exitflag] = fmincon(@(x) static_LuGre(x, MVMF), x0, [], [], [], [], [0 0 0 0], [20 20 20 20], [], options)
%[x, fval, exitflag] = fmincon(@(x) static_LuGre(x, MVMF), x0, [], [], [], [], [0 0 0 0], [30 30 30 30], [], options)
