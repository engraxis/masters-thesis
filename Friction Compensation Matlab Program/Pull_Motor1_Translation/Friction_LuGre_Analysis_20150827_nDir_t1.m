...
DATA31 = [load('SaveData31.dat')];

%% 저장 인덱스에 + 2하면 됨.
figure(1)
% Error
plot(DATA31(1:4000,11))
title('Error [mm/s]')

figure(2)
plot(DATA31(2580:2860,11))

%%
% 1번: 1000:11000
V1 = DATA1(2000:11000, 5);
F1 = DATA1(2000:11000, 9);
P1 = DATA1(2000:11000, 3);
Verr1 = DATA1(2000:11000, 11);
...
figure(5)
stem(pVF1(:,2), 'LineStyle', 'none')
        
%%    
% 2번: 800:6000
V2 = DATA2(1200:6000, 5);
F2 = DATA2(1200:6000, 9);
P2 = DATA2(1200:6000, 3);
Verr2 = DATA2(1200:6000, 11);
...
figure(5)
stem(pVF3(:,2), 'LineStyle', 'none')
%%
% 4: 850:3400
V4 = DATA4(1000:3400, 5);
F4 = DATA4(1000:3400, 9);
Verr4 = DATA4(1000:3400, 11);
idx = find(Verr4 == 0);
VF4 = [V4(idx), F4(idx)];
...
figure(5)
stem(pVF4(:,2), 'LineStyle', 'none')
%%
% 5: 950:3000
V5 = DATA5(1000:3000, 5);
F5 = DATA5(1000:3000, 9);
Verr5 = DATA5(1000:3000, 11);
idx = find(Verr5 == 0);
VF5 = [V5(idx), F5(idx)];
...
figure(5)
stem(pVF5(:,2), 'LineStyle', 'none')
%%
% 6: 800:2500
V6 = DATA6(800:2500, 5);
F6 = DATA6(800:2500, 9);
Verr6 = DATA6(800:2500, 11);
idx = find(Verr6 == 0);
VF6 = [V6(idx), F6(idx)];
...
figure(5)
stem(pVF6(:,2), 'LineStyle', 'none')
%%
% 7: 1750:3100
V7 = DATA7(1750:3100, 5);
F7 = DATA7(1750:3100, 9);
Verr7 = DATA7(1750:3100, 11);
idx = find(Verr7 == 0);
VF7 = [V7(idx), F7(idx)];
...
figure(5)
stem(pVF7(:,2), 'LineStyle', 'none')
%%
% 8: 2550:3800
V8 = DATA8(2550:3800, 5);
F8 = DATA8(2550:3800, 9);
Verr8 = DATA8(2550:3800, 11);
idx = find(Verr8 == 0);
VF8 = [V8(idx), F8(idx)];
...
figure(5)
stem(pVF8(:,2), 'LineStyle', 'none')
%%
% 9: 2550:3600
V9 = DATA9(2550:3600, 5);
F9 = DATA9(2550:3600, 9);
Verr9 = DATA9(2550:3600, 11);
idx = find(Verr9 == 0);
VF9 = [V9(idx), F9(idx)];
...
figure(5)
stem(pVF9(:,2), 'LineStyle', 'none')
%%
% 10: 2600:3550
V10 = DATA10(2600:3550, 5);
F10 = DATA10(2600:3550, 9);
Verr10 = DATA10(2600:3550, 11);
idx = find(Verr10 == 0);
...
figure(5)
stem(pVF10(:,2), 'LineStyle', 'none')
%%
% 11: 2550:3350
V11 = DATA11(2600:3350, 5);
F11 = DATA11(2600:3350, 9);
Verr11 = DATA11(2600:3350, 11);
idx = find(Verr11 == 0);
...
figure(5)
stem(pVF11(:,2), 'LineStyle', 'none')
%%
% 12: 2550:3300
V12 = DATA12(2600:3300, 5);
F12 = DATA12(2600:3300, 9);
Verr12 = DATA12(2600:3300, 11);
idx = find(Verr12 == 0);
...
figure(5)
stem(pVF12(:,2), 'LineStyle', 'none')
%%
% 13: 2500:3200
V13 = DATA13(2500:3200, 5);
F13 = DATA13(2500:3200, 9);
Verr13 = DATA13(2500:3200, 11);
idx = find(Verr13 == 0);
...
figure(5)
stem(pVF13(:,2), 'LineStyle', 'none')
%%
% 14: 2550:3200
V14 = DATA14(2650:3200, 5);
F14 = DATA14(2650:3200, 9);
Verr14 = DATA14(2650:3200, 11);
idx = find(Verr14 == 0);
...
figure(5)
stem(pVF14(:,2), 'LineStyle', 'none')
%%
% 15: 2550:3150
V15 = DATA15(2550:3150, 5);
F15 = DATA15(2550:3150, 9);
Verr15 = DATA15(2550:3150, 11);
idx = find(Verr15 == 0);
...
figure(5)
stem(pVF15(:,2), 'LineStyle', 'none')
%%
% 16: 2700:3300
V16 = DATA16(2700:3300, 5);
F16 = DATA16(2700:3300, 9);
Verr16 = DATA16(2700:3300, 11);
idx = find(Verr16 == 0);
...
figure(5)
stem(pVF16(:,2), 'LineStyle', 'none')
%%
% 17: 2500:3000
V17 = DATA17(2500:3000, 5);
F17 = DATA17(2500:3000, 9);
Verr17 = DATA17(2500:3000, 11);
idx = find(Verr17 == 0);
...
figure(5)
stem(pVF17(:,2), 'LineStyle', 'none')
%%
% 18: 2500:3000
V18 = DATA18(2550:3000, 5);
F18 = DATA18(2550:3000, 9);
Verr18 = DATA18(2550:3000, 11);
idx = find(Verr18 == 0);
...
figure(5)
stem(pVF18(:,2), 'LineStyle', 'none')
%%
% 19: 2550:3000
V19 = DATA19(2600:3000, 5);
F19 = DATA19(2600:3000, 9);
Verr19 = DATA19(2600:3000, 11);
idx = find(Verr19 == 0);
...
figure(5)
stem(pVF19(:,2), 'LineStyle', 'none')
%%
% 20: 2580:3000
V20 = DATA20(2580:3000, 5);
F20 = DATA20(2580:3000, 9);
Verr20 = DATA20(2580:3000, 11);
idx = find(Verr20 == 0);
...
figure(5)
stem(pVF20(:,2), 'LineStyle', 'none')
%%
% 21: 2600:3000
V21 = DATA21(2600:3000, 5);
F21 = DATA21(2600:3000, 9);
Verr21 = DATA21(2600:3000, 11);
idx = find(Verr21 == 0);
...
figure(5)
stem(pVF21(:,2), 'LineStyle', 'none')
%%
% 22: 2480:2880
V22 = DATA22(2500:2880, 5);
F22 = DATA22(2500:2880, 9);
Verr22 = DATA22(2500:2880, 11);
idx = find(Verr22 == 0);
...
figure(5)
stem(pVF22(:,2), 'LineStyle', 'none')
%%
% 23: 2580:2950
V23 = DATA23(2580:2950, 5);
F23 = DATA23(2580:2950, 9);
Verr23 = DATA23(2580:2950, 11);
idx = find(Verr23 == 0);
...
figure(5)
stem(pVF23(:,2), 'LineStyle', 'none')
%%
% 24: 2600:2950
V24 = DATA24(2600:2950, 5);
F24 = DATA24(2600:2950, 9);
Verr24 = DATA24(2600:2950, 11);
idx = find(Verr24 == 0);
...
figure(5)
stem(pVF24(:,2), 'LineStyle', 'none')
%%
% 25: 2650:2950
V25 = DATA25(2650:2950, 5);
F25 = DATA25(2650:2950, 9);
Verr25 = DATA25(2650:2950, 11);
idx = find(Verr25 == 0);
...
figure(5)
stem(pVF25(:,2), 'LineStyle', 'none')
%%
% 26: 2550:2850
V26 = DATA26(2600:2850, 5);
F26 = DATA26(2600:2850, 9);
Verr26 = DATA26(2600:2850, 11);
idx = find(Verr26 == 0);
...
figure(5)
stem(pVF26(:,2), 'LineStyle', 'none')
%%
% 27: 2550:2850
V27 = DATA27(2550:2850, 5);
F27 = DATA27(2550:2850, 9);
Verr27 = DATA27(2550:2850, 11);
idx = find(Verr27 == 0);
...
figure(5)
stem(pVF27(:,2), 'LineStyle', 'none')
%%
% 28: 2700:2900
V28 = DATA28(2740:2900, 5);
F28 = DATA28(2740:2900, 9);
Verr28 = DATA28(2740:2900, 11);
idx = find(Verr28 == 0);
...
figure(5)
stem(pVF28(:,2), 'LineStyle', 'none')
%%
% 29: 2600:2880
V29 = DATA29(2600:2880, 5);
F29 = DATA29(2600:2880, 9);
Verr29 = DATA29(2600:2880, 11);
idx = find(Verr29 == 0);
...
figure(5)
stem(pVF29(:,2), 'LineStyle', 'none')
%%
% 30: 2550:2800
V30 = DATA30(2550:2800, 5);
F30 = DATA30(2550:2800, 9);
Verr30 = DATA30(2550:2800, 11);
idx = find(Verr30 == 0);
...
figure(5)
stem(pVF30(:,2), 'LineStyle', 'none')
%%
% 31: 2580:2860
V31 = DATA31(2620:2860, 5);
F31 = DATA31(2620:2860, 9);
Verr31 = DATA31(2620:2860, 11);
idx = find(Verr31 == 0);
VF31 = [V31(idx), F31(idx)];

figure(3)
stem(VF31(:,1), 'LineStyle', 'none')
figure(4)
stem(VF31(:,2), 'LineStyle', 'none')
...
mVF31 = [mean(pVF31(:,1)), mean(pVF31(:,2))];
...
pmV = [mVF1(:,1), mVF2(:,1), mVF3(:,1), mVF4(:,1), mVF5(:,1), ...
    ...
    mVF26(:,1), mVF27(:,1), mVF28(:,1), mVF29(:,1), mVF30(:,1), mVF31(:,1)];
...
pmF = [mVF1(:,2), mVF2(:,2), mVF3(:,2), mVF4(:,2), mVF5(:,2), ...
    ...
    mVF26(:,2), mVF27(:,2), mVF28(:,2), mVF29(:,2), mVF30(:,2), mVF31(:,2)];
...
%x0 = [0.73 0.0 0.01 0.0];
%x0 = [0.80 0.0 0.01 0.0];

x0 = [0.9 0.0 8.1 0.001];

options = optimoptions('fmincon', 'TolX', 1e-11);
%[x, fval, exitflag] = fmincon(@(x) static_LuGre(x, MVMF), x0, [], [], [], [], [0 0 0 0], [10 10 10 10], [], options)

[x, fval, exitflag] = fmincon(@(x) static_LuGre(x, MVMF), x0, [], [], [], [], [0 0 0 0], [50 50 50 50], [], options)
