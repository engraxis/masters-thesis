...
QT_MOC_LITERAL(1, 20, 15), // "messageDispatch"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "SerialCommunication\0messageDispatch\0"
    ""
};
...
void SerialCommunication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SerialCommunication::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialCommunication::messageDispatch)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SerialCommunication::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialCommunication.data,
...
// SIGNAL 0
void SerialCommunication::messageDispatch(QString _t1, QString _t2)
{
